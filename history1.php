...
// Database connection
$conn = new mysqli('localhost', 'root', '', 'mywebsite'); // change DB info if needed
...
<style>
/* You can keep this small addition if you want */
.history-actions {
    margin-top: 10px;
    display: flex;
    gap: 10px;
...
<header class="header">
    <div class="container header-container">
        ...
        <nav class="nav-desktop">
            ...
            <a href="entry.php" class="nav-link">New Entry</a>
            <a href="dashboard.php" class="nav-link">Mood Graph</a>
                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="history-card">
                        ...
                        <div class="history-actions">
                            <a href="edit_mood.php?id=<?php echo $row['id']; ?>" class="btn btn-outline">Edit</a>
                            <a href="delete_mood.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this mood?');">Delete</a>
                        </div>
                    </div>
                <?php endwhile; ?>
            </div>
